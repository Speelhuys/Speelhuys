...
// Haalt gegevens op als ze bestaan
...
<body style="background-image: url(../images/background.png); background-attachment: fixed; background-size: 100%;">
    ...
    <div class="container-fluid">
        ...
        if (isset($_GET['message'])) {
            echo '<br /><div style="background-color: green;margin: auto; width: 23%; text-align: center;">' . $_GET['message'] . '</div><br />';
        }
        ?>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <br />
                                        <a href="setEdit.php?id=<?php echo $set->id; ?>" style="position: absolute; bottom: 0; left: 10;">Edit</a>
                                        <?php
                                        if ($user->role == "admin") {
                                            echo '<a href="setDelete.php?id=' . $set->id . '" style="color: red;position: absolute; bottom: 0; margin-left: 260px" onclick=';
                                            echo "'";
