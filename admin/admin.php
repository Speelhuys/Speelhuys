...
<body style="background-image: url(../images/brickwall.png); background-repeat:no-repeat; background-position: fixed; background-size: 100%;">
    ...
    <div class="container-fluid">
        ...
        <div class="mb-3">
            <div class="row">
                <input type="text" name="searchBar" class="form-control" style="width: 50%;" placeholder="Plaats hier uw zoekopdracht">
                <h3>OF</h3>
